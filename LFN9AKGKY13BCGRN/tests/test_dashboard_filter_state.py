...
def test_recent_claims_view_callback_syncs_radio_aliases(monkeypatch):
    session_state = {
...
def test_dashboard_imports_when_navigation_claim_view_constants_are_missing(monkeypatch):
    ...
    monkeypatch.setitem(
        ...
        _module(
            ...
            get_cached_recent_claims=lambda *args, **kwargs: [],
            get_filtered_recent_claims_local_all=lambda *args, **kwargs: [],
        ),
    )
    monkeypatch.setitem(
        sys.modules,
