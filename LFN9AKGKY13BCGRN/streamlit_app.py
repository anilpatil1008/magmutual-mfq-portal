...
from services.rbac_service import apply_selected_role, get_available_roles, get_current_user_context, get_selected_sf_role
...
if selected_sf_role:
    apply_selected_role(session, selected_sf_role)
